...
public class JeeThinkConfig
{
    ...
    public String getProductorNike() {
        return productorNike;
    }

    public void setProductorNike(String productorNike) {
        this.productorNike = productorNike;
    }
